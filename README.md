...
Provided is an [example notebook](https://github.com/AllenNeuralDynamics/aind-ophys-nwb/examples/nwb_visualization_notebook.ipynb) examining the contents of the NWB.
